<?php
$sInitialBN="Sadaqah Foundation USA";
$sInitialEN="Sadaqah Foundation USA";
$sSiteName="Sadaqah Foundation USA";
$sSiteTitle="Sadaqah Foundation USA";
$sAuthor="sadaqahusa.org";
$sDeveloper="emythmakers.com";
$sEmail="editor@sadaqahusa.org";
$sAppId="";

//Local
$sSiteURL="http://localhost/sadaqah-foundation/";
$sCurrURL="http://localhost/sadaqah-foundation".$_SERVER["REQUEST_URI"];
